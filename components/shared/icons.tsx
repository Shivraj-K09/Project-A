...
export const ChatRoundBoldIcon = React.memo((props: SvgProps) => (
...
export const ChatRoundLinearIcon = React.memo((props: SvgProps) => (
...
// solar:camera-bold
export const CameraBoldIcon = React.memo((props: SvgProps) => (
...
// solar:camera-linear
export const CameraLinearIcon = React.memo((props: SvgProps) => (
...
// solar:phone-bold
export const PhoneBoldIcon = React.memo((props: SvgProps) => (
...
// solar:phone-linear
export const PhoneLinearIcon = React.memo((props: SvgProps) => (
...
// solar:user-bold
export const UserBoldIcon = React.memo((props: SvgProps) => (
...
// solar:user-linear
export const UserLinearIcon = React.memo((props: SvgProps) => (
...
// solar:leaf-bold
export const LeafBoldIcon = React.memo((props: SvgProps) => (
...
// solar:leaf-linear
export const LeafLinearIcon = React.memo((props: SvgProps) => (
...
// google icon
export const GoogleIcon = React.memo(({ size = 20 }: { size?: number }) => (
